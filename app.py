...
app = Flask(__name__)
app.secret_key = 'neyo-secret-key-2024-change-in-production'
DB_PATH = os.path.join(os.path.dirname(__file__), 'instance', 'neyo.db')
...
def init_db():
    ...
    if not admin:
        ...
        products = [
            ...
            ('Fresh Maize (Corn)','crops','Sweet, tender maize from our open-field farms. Available in cobs or shelled.',1500,'bag (100 cobs)',300,'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400',1),
            ...
            ('Live Giant African Snails','snails','Healthy, well-grown giant African land snails (Archachatina marginata).',2000,'dozen',600,'https://images.unsplash.com/photo-1589803568827-c1c58f668d7d?w=400',1),
            ('Live Pigs (Weaner)','pig','Healthy weaner pigs from our biosecure pig farm, ready for fattening.',35000,'head',80,'https://images.unsplash.com/photo-1604848698030-c434ba08ece1?w=400',1),
        ...
        posts = [
            ('Why Integrated Farming is the Future of Nigerian Agriculture','integrated-farming-future-nigeria',
             'Integrated farming combines multiple agricultural activities on a single farm. This synergy reduces waste, maximises land use, and boosts income. At Neyo, we have pioneered this model in Nigeria, creating a sustainable food system that benefits farmers, consumers, and communities alike.',
            ...
            ('Top Tips for Buying Quality Catfish in Nigeria','buying-quality-catfish-nigeria',
             'Catfish is a staple protein source in Nigeria, but not all catfish are equal in quality. Look for clear eyes, firm flesh, fresh smell, and active movement if buying live. At Neyo Fish, we guarantee freshness in every order.',
             'Expert guide to choosing the freshest, best-quality catfish.','fish',
            ...
            ('Snail Farming: The Quiet Gold Mine in Nigerian Agriculture','snail-farming-nigeria-gold-mine',
             'Giant African snails require minimal space, low feed costs, and have exceptionally high protein content. Neyo Snails division has been at the forefront of commercial snail production, supplying restaurants and households across Nigeria.',
             'Snail farming is booming. Learn why more farmers are turning to this lucrative livestock.','snails',
