...
DB_PATH = os.path.join(BASE_DIR, ‘neyo.db’)

app = Flask(**name**, template_folder=TEMPLATE_DIR, static_folder=STATIC_DIR)
app.secret_key = os.environ.get(‘SECRET_KEY’, ‘neyo-secret-key-2024’)
...
products = [
(‘Fresh Yam Tubers’, ‘crops’, ‘Premium quality yam tubers freshly harvested.’, 4500, ‘bag’, 200, ‘https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400’, 1),
(‘Dried Pepper’, ‘crops’, ‘Sun-dried red pepper rich in flavour.’, 2800, ‘kg’, 150, ‘https://images.unsplash.com/photo-1526346698789-22fd84314424?w=400’, 1),
(‘Fresh Maize’, ‘crops’, ‘Sweet tender maize from our open-field farms.’, 1500, ‘bag’, 300, ‘https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400’, 1),
(‘Live Broiler Chicken’, ‘poultry’, ‘Healthy broiler chickens from our modern facility.’, 6500, ‘bird’, 500, ‘https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=400’, 1),
(‘Fresh Table Eggs’, ‘poultry’, ‘Fresh large-grade eggs, 30 per crate.’, 3200, ‘crate’, 1000, ‘https://images.unsplash.com/photo-1518569656558-1f25e69d2fd4?w=400’, 1),
(‘Fresh Catfish’, ‘fish’, ‘Live or dressed catfish from our fish ponds.’, 3800, ‘kg’, 400, ‘https://images.unsplash.com/photo-1534482421-64566f976cfa?w=400’, 1),
(‘Tilapia Fish’, ‘fish’, ‘Fresh tilapia farmed in clean water systems.’, 2900, ‘kg’, 350, ‘https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?w=400’, 1),
(‘Giant African Snails’, ‘snails’, ‘Healthy well-grown giant African land snails.’, 2000, ‘dozen’, 600, ‘https://images.unsplash.com/photo-1589803568827-c1c58f668d7d?w=400’, 1),
(‘Live Pigs Weaner’, ‘pig’, ‘Healthy weaner pigs ready for fattening.’, 35000, ‘head’, 80, ‘https://images.unsplash.com/photo-1604848698030-c434ba08ece1?w=400’, 1),
(‘Pork Dressed’, ‘pig’, ‘Fresh dressed pork from organically raised pigs.’, 5500, ‘kg’, 120, ‘https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=400’, 1),
]
db.executemany(
‘INSERT INTO products (name,category,description,price,unit,stock,image_url,available) VALUES (?,?,?,?,?,?,?,?)’,
products
)
posts = [
(‘Why Integrated Farming is the Future’, ‘integrated-farming-future’,
‘Integrated farming combines crops, livestock and aquaculture on one farm. At Neyo we have pioneered this model in Nigeria creating a sustainable food system.’,
‘How integrated farming transforms Nigerian agriculture.’, ‘farming’,
‘https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600’, 1),
(‘Tips for Buying Quality Catfish’, ‘buying-quality-catfish’,
‘Look for clear eyes, firm flesh and fresh smell. At Neyo Fish we guarantee freshness in every order we deliver.’,
‘Guide to choosing the freshest catfish in Nigeria.’, ‘fish’,
‘https://images.unsplash.com/photo-1534482421-64566f976cfa?w=600’, 1),
(‘Snail Farming: A Gold Mine’, ‘snail-farming-gold-mine’,
‘Giant African snails require minimal space and have high protein content. Neyo Snails supplies restaurants and households across Nigeria.’,
‘Why snail farming is one of the most lucrative ventures.’, ‘snails’,
‘https://images.unsplash.com/photo-1589803568827-c1c58f668d7d?w=600’, 1),
]
db.executemany(
‘INSERT INTO blog_posts (title,slug,content,excerpt,category,image_url,published) VALUES (?,?,?,?,?,?,?)’,
posts
)
db.commit()
db.close()
